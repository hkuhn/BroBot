...
public final class pimu_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.pimu_t.class))
            return 0L;
 
        classes.add(lcmtypes.pimu_t.class);
    ...
    public static lcmtypes.pimu_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        lcmtypes.pimu_t o = new lcmtypes.pimu_t();
    ...
    public lcmtypes.pimu_t copy()
    {
        lcmtypes.pimu_t outobj = new lcmtypes.pimu_t();
