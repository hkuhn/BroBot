...
public class ArmDriver implements LCMSubscriber
{
    ...
    public ArmDriver(AbstractBus bus, String chanCommand, String chanStatus)
    {
        // self-test
    ...
    public static void main(String args[]) throws IOException
    {
        ...
        gopt.addString('s', "chanStatus", "ARM_STATUS", "LCM channel for dynamixel_status_list_t");
        gopt.addString('c', "chanCommand", "ARM_COMMAND", "LCM channel for dynamixel_command_list_t");
        ...
        new ArmDriver(bus, gopt.getString("chanCommand"), gopt.getString("chanStatus")).run();
    }
}
