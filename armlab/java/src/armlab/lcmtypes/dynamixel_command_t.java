...
public final class dynamixel_command_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(armlab.lcmtypes.dynamixel_command_t.class))
            return 0L;
 
        classes.add(armlab.lcmtypes.dynamixel_command_t.class);
    ...
    public static armlab.lcmtypes.dynamixel_command_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        armlab.lcmtypes.dynamixel_command_t o = new armlab.lcmtypes.dynamixel_command_t();
    ...
    public armlab.lcmtypes.dynamixel_command_t copy()
    {
        armlab.lcmtypes.dynamixel_command_t outobj = new armlab.lcmtypes.dynamixel_command_t();
