...
public class BallDetectionDetector
{
    ...
    public int[] findBall(BufferedImage img, ParameterGUI pg)
    {
        int mythresh = pg.gi("kthresh");
...
ballStats.min_x, ballStats.min_y, ballStats.max_x, ballStats.max_y);
    ...
    int frame = 0;
    public void runDetector(BufferedImage im)
    {

        int bounds[] = findBall(im, pg);
